document.addEventListener('DOMContentLoaded', () => {
  ...
  const tagData = {
    ...
    'HG': {
      type: `术语`,
      value: `Hit Gauge<br>生命量谱。`,
    },
    'HP': {
      type: `术语`,
      value: `Hit Points<br>生命值。`,
    },
    'SG': {
      type: `术语`,
      value: `Stamina Gauge<br>精力量谱。`,
    },
    'SP': {
      type: `术语`,
    ...
    'R': {
      type: `标签`,
      value: `这种稀有度的事物需要特殊的训练或特定文化的背景才有可能接触。<a href=##>分析</a>稀有度为R的事物时，达成度会受到4点减值。`,
    },
    'S': {
      type: `标签`,
      value: `这种稀有度的事物几乎不可能被找到。<a href=##>分析</a>稀有度为S的事物时，达成度会受到8点减值。`,
    },
    'U': {
      type: `标签`,
      value: `这种稀有度的事物是独一无二的。<a href=##>分析</a>稀有度为U的事物时，达成度会受到12点减值。`,
    },
    ...
    '畸变种': {
      type: `标签`,
      value: `畸变种的生命具有能够让自己呈现出一种或多种形态的超自然能力。`,
    },
    '妖精种': {
      type: `标签`,
      value: `妖精种的生命诞生自千奇百怪的自然现象。`,
    },
    '鬼神种': {
      type: `标签`,
    ...
    '构造体': {
      type: `标签`,
      value: `构造体通常是如机器人、魔像等个体那样的人造生命。构造体的功能和智能则取决于其设计和制造者的技术。`,
    },
    '野兽': {
      type: `标签`,
    ...
    '休整': {
      type: `标签`,
      value: `这种效果只能在休整场景，或是角色未登场的场景中使用。<br>
    ...
    '即死': {
      type: `标签`,
      value: `在即死效果造成的伤害结算后，所有受其损伤的HG都会被立即击破。部分即死效果可以在不造成损伤的情况下直接致死。`,
    },
    ...
    '弹药': {
      type: `标签`,
      value: `每次使用这种物品都会消耗1发弹药。如果弹药耗尽，则无法再次使用这件物品。角色可以通过【交互】重装1件物品的所有弹药。`,
    },
    ...
    '缓慢': {
      type: `处境`,
      value: `角色每轮的待机值最多可以增加等于强度的数值。由施加者在待机值每次增加时决定是否增加。<br>
    ...
    '禁足': {
      type: `处境`,
      value: `角色无法执行<a href=##>移动</a>动作。<br>
    ...
    '持续伤害': {
      type: `处境`,
      value: `每轮结束时，受到持续伤害的角色会根据伤害类型，在HP或SP上承受损伤，如同受到一次威力与强度相当的伤害。场景结束时，所有持续伤害都会自动解除。`,
    },
    ...
    '迅捷': {
      type: `处境`,
      value: `角色每轮的待机值最多可以降低等于强度的数值。<br>
