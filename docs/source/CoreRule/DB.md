...
《|原型|[魔战士]》<br>
——————————————————————————————<br>
你额外习得1次【魔道学者】。所选术源必须具有「器械驱动[武器]」缺陷。将【先验术式】记录在该术源的记忆体中。<br>
...
**前置**：【魔道学者】<br>
——————————————————————————————<br>
习得本特技时，选择1种秘仪。使用通过【魔道学者】获得的术源，施行归属于所选秘仪的《|交战|》术法时，攻击检定的会心值可以获得1点内在加值。<br>
...
《|原型|[祭司]》<br>
——————————————————————————————<br>
你额外习得1次【魔道学者】，必须选择《|契绊|》作为术源的派系。随后选择1项《|秘术|[奇迹]》术法记录在该术源的记忆体中。<br>
每习得1项《|原型|[祭司]》特技，你就可以将通过本特技获得的术源增加1级。<br>

##### 灵媒　　　　　｜　参谋 0
《|原型|[灵媒]》<br>
——————————————————————————————<br>
你额外习得1次【魔道学者】，必须选择《|契绊|》作为术源的派系。随后将【显现化身】记录在该术源的记忆体中。<br>
...
《|原型|[先知]》<br>
——————————————————————————————<br>
你额外习得1次【魔道学者】，必须选择《|契绊|》作为术源的派系。随后将【先验术式】记录在该术源的记忆体中。<br>
